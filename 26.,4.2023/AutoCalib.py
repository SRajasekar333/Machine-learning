...
def main():
    ...
    Parser.add_argument('--ImageFolderPath', default= "Calibration_Imgs", help='Data path')
    #C:/Users/rajas/OneDriveD/esktop/Camera_calibration/Zhang/abhijit/zhang-camera-calibration-master/zhang-camera-calibration-master/Code/Data/Calibration_Imgs
