...
imagesLeft = sorted(glob.glob('images/stereoimages17042023/stereoLeft(H) - 17042023_2diffcam_chess/*.png'))
#imagesLeft = sorted(glob.glob('images/stereoLeft - Copy/*.png'))

imagesRight = sorted(glob.glob('images/stereoimages17042023/stereoRight(J) - 17042023_2diffcam_chess/*.png'))
...
print("UndistortedcameraMatrixL",cameraMatrixL)
...
print("UndistortedcameraMatrixR",cameraMatrixR)
