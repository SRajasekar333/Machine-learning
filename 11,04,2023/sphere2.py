...
img = cv.imread("sphere6.jpg", cv.IMREAD_GRAYSCALE)
...
while True:
    ...
    circles = cv.HoughCircles(mask,cv.HOUGH_GRADIENT,1,centerDist,param1=param1,param2=param2,minRadius=minRadius,maxRadius=maxRadius)
